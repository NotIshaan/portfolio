            ...
            <div className="space-y-8">
                <div>
                    ...
                    <div className="prose prose-invert prose-p:text-slate-400 max-w-none space-y-4">
                        ...
                        <p>
                            Currently working as a Cloud Engineer Intern at TraceLink, I build automation and monitoring solutions that improve system reliability. I also have a strong background in Machine Learning, having deployed computer vision models on edge devices.
                        </p>
                    </div>
                </div>
